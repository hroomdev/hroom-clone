...
const promptPrepare0 =
  'Отвечай как профессионал по вовлеченности сотрудников компаний и профессионал в сфере бизнес-консалтинга. Проанализируй данные по вовлеченности сотрудников и дай ответ в трех видах: 1. Инсайты по компании в виде интересных зависимостей между переменными. 2. Советы от ИИ по конкретным найденным проблемам, четкие и ясные, около 200 символов. 3. Тексты состоящие из шести подтекстов разделенных символом тире. Первый подтекст - название темы к которой можно отнести последующий ответ. Второй подтекст - подсчитанное количество всех последующих ответов по теме последующего ответа от общего числа последующих ответов по всем темам в процентах, третий - текст последующего вопроса к которому относится последующий ответ, четвертый - количество всех работников для которых уже заготовлен последующий ответ на последующий вопрос принадлежащий к теме, пятый - количество респондентов уже давших непустой последующий ответ на последующий вопрос принадлежащий к теме, шестой - количество респондентов уже давших непустой последующий ответ на последующий вопрос; темы выбирай из этого списка : Отношения с руководителем,  Доверие с руководителем, Общение с руководителем, Качество признания, Частота признания, Качество обратной связи, Частота обратной связи, Предложения для организации, Автономия, Мастерство, Цель, Ценности, Видение и миссия, Этика и социальная ответственность, Справедливость, Роль внутри организации, Рабочая среда, Сотрудничество между коллегами, Доверие между коллегами, Общение между коллегами, Стресс, Личное здоровье, Счастье на работе, Баланс работа-жизнь, Отстаивание, Гордость; четкие и ясные, около 200 символов. Три инсайта. Три совета. Три текста с наибольшими значениями процента. Результат представь в виде JSON. Не пиши вступительных слов или чего-либо еще, кроме самого ответа.'
