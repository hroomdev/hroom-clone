...
export const RemixIconsLineSystemErrorWarningLine1 = ({ color = '#A189F2', opacity = 'unset', className }) => {
  return (
    <svg
      className={`remix-icons-line-system-error-warning-line-1 ${className}`}
      fill='none'
      height='24'
      viewBox='0 0 24 24'
      width='24'
...
RemixIconsLineSystemErrorWarningLine1.propTypes = {
