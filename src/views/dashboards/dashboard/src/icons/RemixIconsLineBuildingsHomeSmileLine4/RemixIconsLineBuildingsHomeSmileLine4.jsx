...
export const RemixIconsLineBuildingsHomeSmileLine4 = ({ className }) => {
  return (
    <svg
      className={`remix-icons-line-buildings-home-smile-line-4 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
